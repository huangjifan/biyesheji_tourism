...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/user/myWrite.js"></script>
    ...
    <div class="travel-notes-wrap">
        ...
        <div class="travelogue-title clearfix">
            <div class="travelogue-title-input">
                ...
                <input type="text" class="travelogue-text js-travel-text" id="theme"/>
            </div>
            <div class="travelogue-title-select">
                ...
                <ul class="travel-catalog js-travel-catalog">
                    <li>
						...
						<div class="preview-btn">
				            ...
				            <a href="javaScript:;" class="preview-btn1 preview-red" onclick="submits()"> 下一步 </a>
				        </div>
					</li>
                </ul>
            </div>
