        ...
        <ul class="top_link">
            <li class="dropdown" onmouseout="hideMyTubaba()" onmouseover="showMyTubaba()">
                ...
                <div class="top_down pd_0">
                    <a href="${pageContext.request.contextPath}/indexdo" rel="nofollow">我的订单</a>
                    <a href="${pageContext.request.contextPath}/indexdo" rel="nofollow">我的优惠券</a>
                </div>
            </li>
            <li>
		...
		<div id="J_login" class="topbar_login">
			<c:choose>
				...
				<c:otherwise>
					...
					<a href="register" rel="${pageContext.request.contextPath}/nofollow">免费注册</a>
				</c:otherwise>
			</c:choose>
		</div>
	</div>
...
<div class="lv_nav_bg">
    <div class="lv_nav">
        <ul class="lv_nav_l css3_run" id="2017_lv_nav_li">
            <li id="home"><a onclick="cmCreateElementTag(&#39;首页-PC-上海-顶部导航-00-首页&#39;,&#39;PC首页顶部导航&#39;);" href="http://localhost:1001/index.jsp" rel="nofollow">首页</a></li>
            <li id="destroute" class="pnav_down" onmouseout="hideTravelSonClassify(this)" onmouseover="showTravelSonClassify(this)">
                <a onclick="cmCreateElementTag(&#39;首页-PC-上海-顶部导航-02-国内游&#39;,&#39;PC首页顶部导航&#39;);" href="http://localhost:1001/destroute.jsp">国内游<i class="icon_triangle"></i></a>
            ...
            <li id="around" class="pnav_down" onmouseout="hideTravelSonClassify(this)" onmouseover="showTravelSonClassify(this)">
                <a onclick="cmCreateElementTag(&#39;首页-PC-上海-顶部导航-03-周边游&#39;,&#39;PC首页顶部导航&#39;);" href="http://localhost:1001/zhoubianyou.jsp" data-losc="084208">周边游<i class="icon_triangle"></i></a>
            ...
            <li id="custom" class="pnav_down" onmouseout="hideTravelSonClassify(this)" onmouseover="showTravelSonClassify(this)">
                ...
                <div class="down_nav" style="width: 1423px; left: -537.5px;">
                    <p style="left: 483px;">
                        <a onclick="cmCreateElementTag(&#39;首页-PC-上海-顶部导航-06-定制游-个人定制游&#39;,&#39;PC首页顶部导航&#39;);" class="downNav_personal" href="http://localhost:1001/company.jsp">个人定制游</a>
                    </p>
            ...
            <li id="ticket" class="pnav_down" onmouseout="hideTravelSonClassify(this)" onmouseover="showTravelSonClassify(this)">
            	<a onclick="cmCreateElementTag(&#39;首页-PC-上海-顶部导航-04-景点门票&#39;,&#39;PC首页顶部导航&#39;);" href="http://localhost:1001/ticket.jsp" rel="nofollow">景点门票<i class="icon_triangle"></i><i class="icon_sbx"></i></a>
                <div class="down_nav" style="width: 1423px; left: -389.5px;">
                    <p style="left: 316.5px;">
                        <a onclick="cmCreateElementTag(&#39;首页-PC-上海-顶部导航-04-景点门票-国内门票&#39;,&#39;PC首页顶部导航&#39;);" class="downNav_mp" href="http://localhost:1001/ticket.jsp">国内门票</a>
                    </p>
            ...
            <li id="lvyou" class="pnav_down" onmouseout="hideTravelSonClassify(this)" onmouseover="showTravelSonClassify(this)">
                <a onclick="cmCreateElementTag(&#39;首页-PC-上海-顶部导航-14-旅游攻略&#39;,&#39;PC首页顶部导航&#39;);" href="#">旅游攻略<i class="icon_triangle"></i></a>
                <div class="down_nav" style="width: 1423px; left: -1075.5px;">
                    <p style="left: 971.5px;">
                        <a onclick="cmCreateElementTag(&#39;首页-PC-上海-顶部导航-14-旅游攻略-目的地&#39;,&#39;PC首页顶部导航&#39;);" class="downNav_def" href="http://www.lvmama.com/lvyou/">目的地</a>
                        <!-- <a onclick="cmCreateElementTag('首页-PC-上海-顶部导航-14-旅游攻略-攻略','PC首页顶部导航');" class="downNav_guide" href="http://www.lvmama.com/guide/">攻略</a> -->
                        <a onclick="cmCreateElementTag(&#39;首页-PC-上海-顶部导航-14-旅游攻略-游记&#39;,&#39;PC首页顶部导航&#39;);" class="downNav_yj" href="trip?pageNum=1">游记</a>
                        <a onclick="cmCreateElementTag(&#39;首页-PC-上海-顶部导航-14-旅游攻略-驴游宝&#39;,&#39;PC首页顶部导航&#39;);" class="downNav_lyb" href="http://www.lvmama.com/trip/lvyoubao" target="_blank">驴游宝</a>
                        <a onclick="cmCreateElementTag(&#39;首页-PC-上海-顶部导航-14-旅游攻略-口碑榜&#39;,&#39;PC首页顶部导航&#39;);" href="http://www.lvmama.com/comment/" target="_blank">口碑榜</a>
                        <a onclick="cmCreateElementTag(&#39;首页-PC-上海-顶部导航-14-旅游攻略-问答&#39;,&#39;PC首页顶部导航&#39;);" class="downNav_qa" href="http://www.lvmama.com/lvyou/wenda" target="_blank">问答</a>
                    </p>
