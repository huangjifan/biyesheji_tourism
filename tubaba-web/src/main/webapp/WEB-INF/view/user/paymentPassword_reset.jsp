                ...
                <div class="password_edit_title">
                    ...
                    <h4>重置支付密码</h4>
                        ...
                        <div class="pay_password_content">
                            ...
                            <p><label>新支付密码：</label><input type="password"  onfocus="blurHide(this,'passwordSpan')" id="sso_password" placeholder="请输入6位数字" class="input_text default-text"><span class="tips_warn" id="passwordSpan"></span></p>
                            <p><label>确认新支付密码：</label><input type="password"  onfocus="blurHide(this,'againPasswordSpan')" id="sso_againPassword" class="input_text"><span class="tips_warn" id="againPasswordSpan"></span></p>
