...
<!-- 	<form class="form form-horizontal" id="form-admin-add" action="addtitle" method="post"> -->
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>输入分类名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  value="" placeholder="" id="adminName" name="atrtitle">
				<span id="titlde"></span>
			</div>
		</div>
		<div class="row cl">
