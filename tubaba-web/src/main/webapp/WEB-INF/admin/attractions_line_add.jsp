...
<article class="page-container">
	<form class="form form-horizontal  layui-form" method="post" enctype="multipart/form-data"  action="addLine"  id="form-addLine" onsubmit="return form_addLine()">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>路线名称：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value=""  id="way" name="way">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>旅游天数：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value=""  id="scenicday" name="scenicday">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value=""  id="minimumGroupSize" name="minimumGroupSize">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<!-- 景点分类 -->
				<select id="attractions" name="attractions" class="select">
					<option value="">请选择</option>
				</select>
				</span> 
			</div>
		...
		<div class="row cl">
			 ...
			 <div class="formControls col-xs-8 col-sm-9"> 
				 <div class="layui-upload-drag"  id="test10">
					  ...
					  <img width="310px" height="220px" style="display:none" src="" class="layui-upload-img" id="demo1"/>
					  <p>点击上传商品封面</p>
					  <input id="coverImage"  name="scenicwayImage" hidden="hidden">
				 </div>
			 </div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<script id="editor" name="introduce" type="text/plain" style="width:100%;height:400px;"></script> 
			</div>
		</div>
		<div class="row cl">
