		...
		<div class="row cl">
		    ...
		    <div class="formControls col-xs-8 col-sm-9">
		    	<span class="select-box"  id="sic">
		    		<c:forEach items="${scwaylist}" var="itms" varStatus="status"	>
		    			<input type="radio" name='scenicwayId' value="${itms.id}"  title="${itms.way}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		    		</c:forEach>
		    	</span>
		    </div>
	    </div>
		<div class="row cl">
			 <label class="form-label col-xs-4 col-sm-2">线路图片上传：</label>
...
function submitAdd(){
	$.ajax({
		...
		data:{
			...
			scenicwayId:$('input[name="scenicwayId"]:checked').val(),
