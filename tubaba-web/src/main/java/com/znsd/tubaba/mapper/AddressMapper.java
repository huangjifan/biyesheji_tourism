...
public interface AddressMapper {
	 ...
	 */
	public List<Address> queryProvincesSubCity(@Param("provs") Integer ... provs);
	 ...
	 */
	public List<Address> queryAddressByAreaOrArea_pinyin(@Param("area")String area,@Param("area_pinyin")String area_pinyin);
}
