...
public interface RemarkMapper {
	 ...
	 */
	List<Remark> queryRemarkByScenicwayIdOrScenicId(@Param("scenicwayId") Integer scenicwayId,@Param("scenicId") Integer scenicId);
	 ...
	 * scenicId 景点id
	 * */
	public List<Remark> queryScenicId(int scenicId);
	 ...
	 * 查询加精的评论
	 * */
	public List<Remark> queryScenicIdessence(int scenicId);
	 ...
	 * 查询有图的评论
	 * */
	public List<Remark> queryRemarkImg(int scenicId);
