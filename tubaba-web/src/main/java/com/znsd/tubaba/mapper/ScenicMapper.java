...
public interface ScenicMapper {
	 ...
	 */
	public List<Scenic> queryScenicBySearchScenicnameOrScenicnamePinYin(@Param("scenicname") String scenicname,@Param("scenicname_pinyin") String scenicname_pinyin);
	 ...
	 * @title:主题
	 * */
	public List<Scenic> queryByScenicWithThemeWithAddress(@Param("title")String title,@Param("scope")String scope);
	/**
	 * 热门目的地或者热门景点
	 * @author 杨云鹏
	 * */
	public List<Scenic> qeuryByScenicWithIndentdetails(@Param("frompath") String frompath);
	/**
	 * 按照id查询景点信息
	 */
